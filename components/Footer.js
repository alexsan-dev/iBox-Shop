...
const Footer = props => {
   return (
      <footer>
         ...
         <div id="links">
            <h2>Contacta con nosotros <i className="material-icons">call</i></h2>
            <p>Si tienes algún comentario envianos un mensaje , visita también nuestra página en Facebook. 👍</p>
            <a href="https://facebook.com/tienda.ibox" target="_blank" rel="noreferrer" title="FacebookPage"><i className="icon-facebook"></i> iBox</a>
            <a href="mailto:ceo@ibox.gt" title="Email"><i className="material-icons">mail</i> Email</a>
         </div>
