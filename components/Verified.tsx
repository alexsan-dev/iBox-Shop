...
import { useSendEmailVerification, useDeleteUser, useUserTime } from 'Hooks'
...
const Verified: React.FC<VerifiedProps> = (props: VerifiedProps) => {
	// ESTADO DEL COMPONENTE
	const defaultState: Visibility = { visible: props.show }
	const [visible, setVisible]: [Visibility, Dispatch<SetStateAction<Visibility>>] = useState(
		defaultState
	)
