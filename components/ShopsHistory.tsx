...
const ShopsHistory: React.FC<HistoryProps> = (props: HistoryProps) => {
	// CONTEXTO
				...
				{props.user?.history ? (
					...
					<p>
						...
						<Link href='/tienda' passHref>
							<a title={props.strings.button} className='white waves waves-dark btn'>
								<i className='material-icons'>store</i> {props.strings.button}
							</a>
						</Link>
					</p>
				)}
