...
const CartProductCard: FC<Props> = (props: Props) => {
	...
	const { addToCartEvent, lang } = useContext(appContext)
		...
		<div id='cartCard'>
			...
			<div id='cartCardPrice'>
				<div className='amber'>
					...
					<button className='waves waves-dark' onClick={removeToCartCall}>
						-
					</button>
					<button className='waves waves-dark' onClick={addToCartCall}>
						+
					</button>
				</div>
				<strong>
