...
const Meta: React.FC<Props> = (props: Props) => {
	return (
		<>
			...
			<meta property='og:image' content='https://ibox.gt/images/general/banner.jpg' />
			<meta property='og:image:secure_url' content='https://ibox.gt/images/general/banner.jpg' />
			...
			<meta name='twitter:image' content='https://ibox.gt/images/general/banner.jpg' />
		</>
	)
}
