const Footer: React.FC<ILangFooter> = (props: ILangFooter) => {
	return (
		<footer>
			<div className='st'>
				<img src='/images/home/store.png' alt='iBox Store' />
				...
				<span>
					{props.blobs.contact}{' '}
					<a href='mailto:cto@ibox.gt' title={props.blobs.email}>
						{props.blobs.email}
					</a>
				</span>
			</div>
			...
			<div id='links'>
				...
				<a
					href='https://facebook.com/shops.ibox'
					target='_blank'
					rel='noreferrer'
					title='FacebookPage'>
