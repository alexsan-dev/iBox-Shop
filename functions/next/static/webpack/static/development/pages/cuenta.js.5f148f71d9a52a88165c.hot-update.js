...
const Forms = props => {
  ...
  const logs = () => Object(_utils_hooks__WEBPACK_IMPORTED_MODULE_4__["useLogin"])(account, email, pass).catch(err => setAccount({
  ...
  const fblog = () => Object(_utils_hooks__WEBPACK_IMPORTED_MODULE_4__["useLogin"])("fb").catch(err => setAccount({
    switch: account.switch,
    alert: __jsx(_components_Alert__WEBPACK_IMPORTED_MODULE_3__["default"], {
      title: "Ocurrio un error",
      body: err,
  ...
  const glog = () => Object(_utils_hooks__WEBPACK_IMPORTED_MODULE_4__["useLogin"])("g").catch(err => setAccount({
    switch: account.switch,
    alert: __jsx(_components_Alert__WEBPACK_IMPORTED_MODULE_3__["default"], {
      title: "Ocurrio un error",
      body: err,
...
//# sourceMappingURL=cuenta.js.5f148f71d9a52a88165c.hot-update.js.map