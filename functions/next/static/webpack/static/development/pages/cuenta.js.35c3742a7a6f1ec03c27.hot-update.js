...
const useLogin = async (type, email, pass) => {
  if (type === true) return _credentials_servers__WEBPACK_IMPORTED_MODULE_1__["default"].auth().createUserWithEmailAndPassword(email, pass);else if (type === false) return _credentials_servers__WEBPACK_IMPORTED_MODULE_1__["default"].auth().signInWithEmailAndPassword(email, pass);else if (type === "fb") return _credentials_servers__WEBPACK_IMPORTED_MODULE_1__["default"].auth().signInWithRedirect(fbprovider);else if (type === "g") return _credentials_servers__WEBPACK_IMPORTED_MODULE_1__["default"].auth().signInWithRedirect(gprovider);
};
...
//# sourceMappingURL=cuenta.js.35c3742a7a6f1ec03c27.hot-update.js.map