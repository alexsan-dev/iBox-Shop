...
const Meta = props => {
  return __jsx(external_react_default.a.Fragment, null, __jsx("title", null, props.title), __jsx("meta", {
    name: "author",
    content: "Alex Santos | iBox\xAE"
  }), __jsx("meta", {
    name: "Robots",
    content: "follow"
  }), __jsx("meta", {
    ...
    property: "og:image",
    content: "https://ibox.gt/images/banner.jpg"
  }), __jsx("meta", {
    property: "og:image:secure_url",
    content: "https://ibox.gt/images/banner.jpg"
  }), __jsx("meta", {
    property: "og:url",
    content: "https://ibox.gt"
  }), __jsx("meta", {
...
class _document_iBoxDoc extends document_default.a {
  ...
  render() {
    ...
    }), _document_jsx(next_document["Head"], null, _document_jsx(components_Meta, {
      title: "iBox - \xA1Tienda en l\xEDnea de accesorios y electr\xF3nica!",
      desc: "Somos una empresa dedicada a la venta de accesorios \uD83D\uDCF1 y electr\xF3nica en tiendas online. Entra y conoce nuestra amplia gama de productos para ti \uD83D\uDD25."
    })), _document_jsx("body", null, _document_jsx(next_document["Main"], null), _document_jsx(next_document["NextScript"], null)));
  }

}

/* harmony default export */ var _document = __webpack_exports__["default"] = (_document_iBoxDoc);
